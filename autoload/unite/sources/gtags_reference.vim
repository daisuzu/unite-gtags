...
call unite#util#set_default('g:unite_source_global_reference_opt', '-r')

let s:source_gtags = {
      \ 'name': 'gtags/reference',
      \ 'hooks' : {},
      \ }
...
function! s:source_gtags.gather_candidates(args, context)
  let cmdline = printf('%s %s %s %s',
    ...
    \   g:unite_source_global_reference_opt,
...
function! unite#sources#gtags_reference#define()
